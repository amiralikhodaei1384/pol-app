...
/// منوی پروفایل نوار بالا؛ مشترک بین داشبورد دانشجو و کارفرما.
    ...
    return PopupMenuButton<String>(
      ...
      itemBuilder: (context) => [
        ...
        PopupMenuItem<String>(
          ...
          height: 48,
          padding: const EdgeInsets.symmetric(horizontal: 12),
          child: _menuRow(Icons.person_outline_rounded, profileLabel, const Color(0xFF1E6AFB)),
        ),
        PopupMenuItem<String>(
          value: 'logout',
          height: 48,
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          _ProfileMenuButton(
            name: _studentName,
            roleLabel: 'حساب دانشجویی',
            profileLabel: 'ویرایش پروفایل من',
            onProfile: _openProfileBuilder,
            onLogout: _logout,
          ),
        ],
      ),
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          _ProfileMenuButton(
            name: _companyName,
            roleLabel: 'حساب کارفرما',
            profileLabel: 'ویرایش پروفایل شرکت',
            onProfile: _openCompanyProfile,
            onLogout: _logout,
          ),
        ],
      ),
